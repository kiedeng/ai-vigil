...
class ModelPerformanceTest(Base, TimestampMixin):
    ...
    runs: Mapped[list["ModelPerformanceRun"]] = relationship(back_populates="test", cascade="all, delete-orphan")


class ModelPerformanceRun(Base, TimestampMixin):
    __tablename__ = "model_performance_runs"

    id: Mapped[int] = mapped_column(Integer, primary_key=True, index=True)
    test_id: Mapped[int] = mapped_column(
        ForeignKey("model_performance_tests.id", ondelete="CASCADE"), nullable=False, index=True
    )
